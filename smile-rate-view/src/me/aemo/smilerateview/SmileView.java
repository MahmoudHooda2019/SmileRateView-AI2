...
import me.aemo.smilerateview.BackgroundAnimationDrawable;
import me.aemo.smilerateview.BackgroundDrawable;
...
public class SmileView extends LinearLayout implements Animator.AnimatorListener {
    ...
    public SmileView setDefaultBottom(int defaultBottom) {
        this.defalutBottom = defaultBottom;
        return this;
    }
    ...
    public void setDefaultGravity(int defaultGravity) {
        this.defalutGravity = defaultGravity;
    }
    public void setDefaultDis(String defaultDis) {
        this.defalutDis = defaultDis;
    }
    ...
    private String defaultLike = "like";
    private String defalutDis = "dislike";
    ...
    private void init() {
        ...
        //添加动画资源  获得帧动画
        try {
            imageLike.setBackground(BackgroundAnimationDrawable.animation_like(getContext()));
        } catch (Exception e) {
        ...
        try {
            imageDis.setBackground(BackgroundAnimationDrawable.animation_dislike(getContext()));
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        ...
        disBack.setBackground(BackgroundDrawable.white_background(getContext()));
        likeBack.setBackground(BackgroundDrawable.white_background(getContext()));
    ...
    private void bindListener() {
        imageDis.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                likeBack.setBackground(BackgroundDrawable.white_background(getContext()));
                disBack.setBackground(BackgroundDrawable.yellow_background(getContext()));
                //重置帧动画
        ...
        imageLike.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setBackgroundColor(Color.parseColor(defaluteShadow));
                disBack.setBackground(BackgroundDrawable.white_background(getContext()));
                likeBack.setBackground(BackgroundDrawable.yellow_background(getContext()));
